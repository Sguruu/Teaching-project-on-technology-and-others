...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Получить MainViewModel, передав database на фабрику
        ...
        // При щелчке rootLayout вызов onMainViewClicked в ViewModel
        rootLayout.setOnClickListener {
            viewModel.onMainViewClicked()
        }

        // update the title when the [MainViewModel.title] changes
        // обновляем title при изменении [MainViewModel.title]
        ...
        // показать счетчик, когда [MainViewModel.spinner] is true
        ...
        // Показать snackbar всегда, когда [ViewModel.snackbar]  обновляется не нулевым значением
